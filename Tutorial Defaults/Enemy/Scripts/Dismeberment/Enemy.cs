...
public class Enemy : MonoBehaviour
{
    ...
    [SerializeField] public float LowerHealthThreshold;
    [SerializeField] private float HealthRestorRate;
    ...
    void Start()
    {
       ...
       // EnemyAI = GetComponent<EnemyAI>();
        DeactivateRagdoll();
        Debug.Log(ragdollRigids);
    }

    private void Update()
    {
        CurrentHealth += HealthRestorRate * Time.deltaTime;
    }
